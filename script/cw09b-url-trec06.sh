...
THREADS=4
QUERIES="/home/michal/06.clean.shuf.val"
K=1000
OUTPUT_DIR="/data/michal/intersect/cw09b-url-trec06"
FILTERED_QUERIES="${OUTPUT_DIR}/$(basename ${QUERIES}).filtered"
PAIRS=${FILTERED_QUERIES}
PAIR_INDEX_BASENAME="${BASENAME}-pair-trec06"
THRESHOLDS="/home/michal/biscorer/data/thresholds/cw09b/thresholds.cw09b.0_01.top20.bm25.06.clean.shuf.val"
QUERY_LIMIT=5000
