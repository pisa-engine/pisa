...
K=100
OUTPUT_DIR="/data/michal/intersect/cw09b-url-100-bi"
FILTERED_QUERIES="${OUTPUT_DIR}/$(basename ${QUERIES}).filtered"
PAIRS=${FILTERED_QUERIES}
PAIR_INDEX_BASENAME="${BASENAME}-pair"
THRESHOLDS="/home/michal/biscorer/data/thresholds/cw09b/thresholds.cw09b.0_01.top5.bm25.05.clean.shuf.test"
QUERY_LIMIT=1000
