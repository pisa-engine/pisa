...
BINARY_FREQ_COLL="/mnt/michal/work/robust/inv"
FWD="/mnt/michal/work/robust/fwd"
INV="/mnt/michal/work/robust/inv"
BASENAME="/mnt/michal/work/v1/robust/robust"
THREADS=16
...
${PISA_BIN}/bigram-index -i "${BASENAME}.yml" -q ${QUERIES}
#
## This will produce both quantized scores and max scores (both quantized and not).
