...
class Server {
  public:
    Server(asio::io_context& ioc, tcp::endpoint endpoint) : acceptor_(ioc, endpoint) { accept(); }
...
int main(int argc, const char** argv)
{
    ...
    App<arg::Index, arg::WandData<arg::WandMode::Required>, arg::Algorithm, arg::Scorer, arg::LogLevel> app{
        "HTTP endpoint to retrieve query results."};
    ...
    prepare_handle_request<block_simdbp_index, wand_raw_index>(
        index,
        wdata,
        app.index_encoding(),
        app.algorithm(),
