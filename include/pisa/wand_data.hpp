...
class wand_data {
   public:
              ...
              BlockSize block_size)
    {
        ...
        std::vector<uint32_t> term_counts;
        ...
        m_term_counts.steal(term_counts);
        ...
        auto scorer_ptr = get_scorer(scorer_name, *this);
        {
            pisa::progress progress("Processing posting lists", coll.size());
            size_t term_id = 0;
            for (auto const &seq : coll) {
                auto v = builder.add_sequence(
                    seq, coll, doc_lens, avg_len, (*scorer_ptr)(term_id), block_size);
    ...
    size_t term_count(uint64_t term_id) const { return m_term_counts[term_id]; }
    ...
    wand_data_enumerator getenum(size_t i) const { return m_block_wand.get_enum(i, max_term_weight(i)); }
    ...
    void map(Visitor &visit)
    {
        visit(m_block_wand, "m_block_wand")(m_doc_lens, "m_doc_lens")(
            m_term_counts, "m_term_counts")(m_term_lens, "m_term_lens")(m_avg_len, "m_avg_len")(
            m_max_len, "m_max_len")(m_collection_len, "m_collection_len")(m_num_docs, "m_num_docs")(
   ...
   private:
    ...
    mapper::mappable_vector<uint32_t> m_term_counts;
