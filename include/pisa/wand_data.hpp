   ...
   public:
        ...
        : m_num_docs(num_docs)
    {
        ...
        for (auto const &seq : coll) {
            size_t term_occurrence_count = std::accumulate(seq.freqs.begin(), seq.freqs.end(), 0U);
        ...
        {
            bm25<std::decay_t<decltype(*this)>> scorer(*this);
    ...
    {
        visit(m_block_wand, "m_block_wand")(m_doc_lens, "m_doc_lens")(m_terms_len, "m_terms_len")(
