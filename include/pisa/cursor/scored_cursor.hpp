...
class ScoredCursor {
  public:
    ...
    [[nodiscard]] PISA_ALWAYSINLINE auto score() -> float { return m_term_scorer(docid(), freq(), true); }
    [[nodiscard]] PISA_ALWAYSINLINE auto secondary_score() -> float { return m_term_scorer(docid(), freq(), false); }
